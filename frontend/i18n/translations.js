...
const translations = {
  en: {
    ...
    chat: {
      ...
      welcomeMessage: "Hi! I'm your assistant. I can help you:\n\n📅 **Calendar:**\n• Schedule meetings and events\n• Check your upcoming schedule\n• Update or cancel events\n\n📧 **Email:**\n• Search for emails\n• Read and summarize emails\n• Draft replies\n\nTry saying something like \"Schedule a meeting on 03/12 at 2pm\" or \"Show my recent emails\"",
      ...
      emailToSummarize: 'Email to Summarize',
  ...
  zh: {
    ...
    chat: {
      title: '日历与邮件助手',
      welcomeMessage: '你好！我是你的助手。我可以帮你：\n\n📅 **日历：**\n• 安排会议和活动\n• 查看日程安排\n• 更新或取消活动\n\n📧 **邮件：**\n• 搜索邮件\n• 阅读和总结邮件\n• 起草回复\n\n试试说「在03/12下午2点安排一个会议」或「显示我最近的邮件」',
